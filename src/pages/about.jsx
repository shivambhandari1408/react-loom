...
function About() {
  ...
  const [allProducts] = useLocalStorage("allProducts", []); // optional
        ...
        {product.reviews && product.reviews.length > 0 ? (
          product.reviews.map((review, index) => (
            <div className="review_card" key={index}>
              ...
              <h3>{review.reviewerName} <span className="verified">✔</span></h3>
              <p>{review.comment}</p>
        ...
        <div className="you-may-also-like">
          ...
          <div className="related-products">
            {relatedProduct.map((item) => (
              <div key={item.id} className="related-product-card" onClick={() => navigate("/about", { state: { product: item } })}>
